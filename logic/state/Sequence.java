...
class Sequence {
	...
	protected boolean isOpenPair() {
		if((size()==2)&&(isOpen()))
			return true;
		return false;
	}
	protected boolean isClosedPair() {
		if((size()==2)&&(isClosed()))
			return true;
		return false;		
	}
	protected boolean isOpenTriple() {
		if((size()==3)&&(isOpen()))
			return true;
		return false;		
	}
	protected boolean isClosedTriple() {
		if((size()==3)&&(isClosed()))
			return true;
		return false;		
	}
	...
	protected static Sequence makePair(Move move1, Move move2) {
	...
	protected static Sequence makeTriple(Sequence pair1, Sequence pair2) {
	...
	protected boolean equals(Sequence other) {
	...
	protected boolean contains(Sequence other) {
